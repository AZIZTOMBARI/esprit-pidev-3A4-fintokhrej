...
class ChatMessageRepository extends ServiceEntityRepository
{
    ...
    public function findConversationPage(
        ...
        if ($beforeId !== null) {
            $types['beforeId'] = ParameterType::INTEGER;
        }
    ...
    private function hydrateMessageRow(array $row, int $viewerId, int $memberCount): array
    {
        ...
        if (!empty($row['meta_json'])) {
            try {
                $decoded = json_decode((string) $row['meta_json'], true, flags: JSON_THROW_ON_ERROR);
        ...
        return [
            ...
            'taskId' => isset($meta['task_id']) ? (int) $meta['task_id'] : null,
